<?php 
  ...
  */
  function modalSaveOpen($idTarget=false,$size = "",$color="black",$title="Empty Title")
  {
    ...
    return '
            <div class="modal fade in show" id="'.$idTarget.'">
  ...
  * @param $title = "title header modal";
  */
  function modalDetailOpen($idTarget=false,$size = "",$color="black",$title="Empty Title",$scroll=false)
  {
    $idTarget = $idTarget == false ? "modalDetail" : $idTarget;
    $scroll = $scroll == false ? " " : " modal-dialog-scrollable";
    return '
              <div class="modal fade " id="'.$idTarget.'">
              <div class="modal-dialog modal-'.$size.$scroll.'">
                <div class="modal-content">
                  <div class="modal-header modal-header-'.$color.'">
                    <h4 class="modal-title title-close">'.$title.'</h4>
                    <button type="button" class="close title-close" data-dismiss="modal" aria-label="Close"><i class="fa fa-times-circle"></i></button>
                  </div>
                  <div class="modal-body">
          ';  
  }
